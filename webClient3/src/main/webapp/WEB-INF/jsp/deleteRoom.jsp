...
<script src="js/deleteRoom.js" type="text/javascript"></script>
</head>
						...
						<div class="card-body col-md-12">
							<form id="retrieve_room_form">
								...
								<div class="form-group row show_info">
									...
									<div class="col-8">
										<input id="room_name" name="room_name" readonly
								...
								<div class="form-group row">
									<div class="offset-4 col-8">
										<button id="delete_room" name="delete_room"
											type="submit" class="btn btn-primary">Xóa phòng</button>
									</div>
								</div>
